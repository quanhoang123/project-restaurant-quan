...
define("SMTP_UNAME", "quan.hoang22@student.passerellesnumeriques.org"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PASSWORD", "htqsrivbcbqbikoz"); //Password for SMTP authentication
